@font-face {
  font-family: "lg";
  src: url(/packs/media/images/64b800aa30714fd916dc.woff2?io9a6k) format("woff2"), url(/packs/media/images/747d038541bfc6bb8ea9.ttf?io9a6k) format("truetype"), url(/packs/media/images/356a0e9cb064c7a196c6.woff?io9a6k) format("woff"), url(/packs/media/images/09cd8e9be7081f216644.svg?io9a6k#lg) format("svg");
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
...
.lg-outer .lg-item:not(.lg-start-end-progress) {
  background: url(/packs/media/images/fcba57cdb89652f9bb54.gif) no-repeat scroll center center transparent;
}
...
.pnlm-load-button{position:absolute;top:50%;left:50%;width:200px;height:100px;margin:-50px 0 0 -100px;background-color:rgba(0,0,0,.7);border-radius:3px;font-size:20px;color:#fff;cursor:pointer;display:inline-block;border:0;padding:0;line-height:1.4}
.pnlm-load-button:hover{background-color:rgba(0,0,0,.8)}
.pnlm-load-button:focus{outline:0;box-shadow:0 0 0 1px #fff inset}
.pnlm-load-button div{display:table;text-align:center;width:100%}
.pnlm-load-button p{display:table-cell;vertical-align:middle}
.pnlm-info-box{font-size:15px;position:absolute;top:50%;left:50%;width:200px;height:150px;margin:-75px 0 0 -100px;background-color:#000;border-radius:3px;display:table;text-align:center;color:#fff;table-layout:fixed;z-index:1}
...
.pnlm-interaction-msg{display:none;pointer-events:none;background:rgba(0,0,0,0.7);opacity:1;transition:opacity .3s ease-in-out;width:100%;height:100%;margin:0;top:0;left:0}
.pnlm-outline{border:1px solid #fff;border-radius:3px;padding:0 2px}
...
.pnlm-hotspot-base{position:absolute;visibility:hidden;cursor:default;vertical-align:middle;top:0;z-index:0}
...
/*# sourceMappingURL=vendors-node_modules_hotwired_turbo-rails_app_javascript_turbo_index_js-node_modules_rails_ac-209fdf-12a3afe8.css.map*/